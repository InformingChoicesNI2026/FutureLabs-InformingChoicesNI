    ...
    return (
        <>
            <Dialog fullWidth maxWidth="sm" open={open} onClose={handleClose}>
                ...
                <DialogContent>
                {event.surveyCount > 0 ? (
                    <Typography color="error">Warning: This event has {event.surveyCount} associated survey(s). In order to protect data, you cannot delete this event until all of its surveys are either deleted or moved to other events.</Typography>
                ) :
